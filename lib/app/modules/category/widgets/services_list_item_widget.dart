          ...
          GestureDetector(
            onTap: () {
              ...
              Get.toNamed(Routes.BOOK_E_SERVICE,
                  arguments: {'eService': widget._service, 'quantity': 1});
            },
            child: Column(
              children: [
                Hero(
                  tag: 'service_list_item' + widget._service.id,
                  child: ClipRRect(
                    ...
                    child: CachedNetworkImage(
                      ...
                      width: 80,
                      fit: BoxFit.cover,
                      imageUrl: widget._service.firstImageUrl,
                ...
                if (widget._service.eProvider.available)
                  Container(
                    width: 80,
              ...
              children: <Widget>[
                ...
                Row(
                  ...
                  children: [
                    ...
                    Ui.getPrice(widget._service.price,
